...
</style></head><body><header><div class="brand">Ledger <i>v3</i></div><nav><button onclick="show('dashboard')">Dashboard</button><button onclick="show('journal')">Journal</button><button onclick="show('settings')">Settings</button></nav></header><main class="wrap">
